...
const Card = () => {
    ...
    const [cartArray,setCartArrary]=useState([]);
    ...
    const getCart=()=>{
        ...
        for(const key in cartItems){
            ...
            tempArrary.push(product)
        }
        setCartArrary(tempArrary)
    }
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        : "No address found"}No address found</p>
                    ...
                    <select onChange={e=> setPaymentOption(e,EventTarget.value)} className="w-full border border-gray-300 bg-white px-3 py-2 mt-2 outline-none">
